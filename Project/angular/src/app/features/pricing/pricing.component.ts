...
@Component({
  ...
  template: `
    ...
    <div style="padding:60px 40px 32px;text-align:center;background:#fff;">
      <div style="font-size:12.5px;font-weight:700;letter-spacing:0.1em;color:#5B4BE3;margin-bottom:12px;">PRICING</div>
      <h1 style="font-family:'Space Grotesk',sans-serif;font-weight:700;font-size:46px;letter-spacing:-0.03em;margin:0 0 16px;color:#0F1115;">Simple, fair pricing</h1>
      <p style="font-size:17px;color:#545A66;line-height:1.6;margin:0 auto 28px;max-width:50ch;">Start free and pay per session, or save with a monthly plan. Cancel anytime.</p>
      <!-- Billing toggle -->
    ...
    <div style="padding:16px 40px 56px;max-width:1000px;margin:0 auto;">
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:22px;">
        ...
        <div style="border:1px solid #ECECEF;border-radius:20px;padding:32px;display:flex;flex-direction:column;">
          ...
          <div style="font-family:'Space Grotesk',sans-serif;font-size:44px;font-weight:700;letter-spacing:-0.02em;color:#0F1115;margin-bottom:4px;">$0</div>
          <div style="font-size:13.5px;color:#8A909C;margin-bottom:24px;">Pay per session</div>
          ...
          <button style="width:100%;font-family:inherit;cursor:pointer;background:#fff;border:1px solid #DDDFE6;color:#16181D;font-weight:700;font-size:14.5px;padding:13px;border-radius:12px;">Get started</button>
        </div>
        ...
        <div style="border:2px solid #5B4BE3;border-radius:20px;padding:42px 32px 32px;position:relative;box-shadow:0 20px 44px rgba(91,75,227,0.18);display:flex;flex-direction:column;">
          ...
          <div style="font-family:'Space Grotesk',sans-serif;font-size:44px;font-weight:700;letter-spacing:-0.02em;color:#0F1115;margin-bottom:4px;">
            {{ proPrice() }}<span style="font-size:17px;color:#8A909C;font-weight:600;">/mo</span>
          </div>
          <div style="font-size:13.5px;color:#8A909C;margin-bottom:24px;">8 sessions / month</div>
          <div style="display:flex;flex-direction:column;gap:12px;font-size:14px;color:#545A66;flex:1;margin-bottom:26px;">
          ...
          <button style="width:100%;font-family:inherit;cursor:pointer;border:none;background:#5B4BE3;color:#fff;font-weight:700;font-size:14.5px;padding:13px;border-radius:12px;box-shadow:0 8px 20px rgba(91,75,227,0.30);">Choose Pro</button>
        </div>
        ...
        <div style="border:1px solid #ECECEF;border-radius:20px;padding:32px;display:flex;flex-direction:column;">
          ...
          <div style="font-family:'Space Grotesk',sans-serif;font-size:44px;font-weight:700;letter-spacing:-0.02em;color:#0F1115;margin-bottom:4px;">
            {{ elitePrice() }}<span style="font-size:17px;color:#8A909C;font-weight:600;">/mo</span>
          </div>
          <div style="font-size:13.5px;color:#8A909C;margin-bottom:24px;">Unlimited sessions</div>
          <div style="display:flex;flex-direction:column;gap:12px;font-size:14px;color:#545A66;flex:1;margin-bottom:26px;">
            <span>&#x2713; Everything in Pro</span>
            <span>&#x2713; Dedicated coach</span>
            <span>&#x2713; Custom nutrition plan</span>
          </div>
          <button style="width:100%;font-family:inherit;cursor:pointer;background:#fff;border:1px solid #DDDFE6;color:#16181D;font-weight:700;font-size:14.5px;padding:13px;border-radius:12px;">Choose Elite</button>
        </div>
    ...
    <div style="max-width:760px;margin:56px auto 0;padding:0 40px 80px;">
      <h2 style="font-family:'Space Grotesk',sans-serif;font-weight:700;font-size:26px;color:#0F1115;margin:0 0 20px;">Pricing questions</h2>
