    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;min-height:100vh;">
      ...
      <div style="background:linear-gradient(158deg,#4A3DAE,#2C2370);padding:56px 48px;color:#fff;display:flex;flex-direction:column;justify-content:space-between;">
        ...
        <div style="display:flex;align-items:center;gap:10px;">
          ...
          <span style="font-family:'Space Grotesk',sans-serif;font-weight:700;font-size:19px;letter-spacing:-0.02em;color:#fff;">BookEase</span>
        </div>
        ...
        <div>
          ...
          <p style="font-size:16px;color:#C7C2E8;line-height:1.6;margin:0 0 28px;">Verified coaches, real-time availability, and seamless bookings — all in one place.</p>
        ...
        <div style="display:flex;align-items:flex-start;gap:12px;">
          ...
          <div>
            <div style="font-size:13.5px;color:#fff;font-weight:600;margin-bottom:4px;">"Booking finally feels effortless."</div>
            <div style="font-size:12.5px;color:#9890C9;">Jordan H. &middot; Member since 2025</div>
          </div>
        </div>
      ...
      <div style="padding:56px;background:#fff;display:flex;flex-direction:column;justify-content:center;align-items:center;">
        <div style="width:100%;max-width:360px;">
          <h1 style="font-family:'Space Grotesk',sans-serif;font-weight:700;font-size:30px;letter-spacing:-0.02em;color:#0F1115;margin:0 0 8px;">Welcome back</h1>
          <p style="font-size:15px;color:#545A66;margin:0 0 28px;">Log in to your BookEase account.</p>
          ...
          <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" style="display:flex;flex-direction:column;gap:16px;">
            ...
            <div>
              ...
              <input
                ...
                [style.boxShadow]="emailFocused() ? '0 0 0 4px rgba(91,75,227,0.13)' : 'none'"
                (focus)="emailFocused.set(true)"
                (blur)="emailFocused.set(false)"
                style="width:100%;height:50px;padding:0 14px;border-radius:12px;font-family:inherit;font-size:14.5px;color:#16181D;box-sizing:border-box;outline:none;" />
            ...
            <div>
              <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px;">
                <label style="font-size:13.5px;font-weight:600;color:#16181D;">Password</label>
                <a href="#" style="font-size:12.5px;font-weight:700;color:#5B4BE3;text-decoration:none;">Forgot?</a>
              </div>
              <div style="position:relative;">
                <input
                  formControlName="password"
                  [type]="showPassword() ? 'text' : 'password'"
                  [style.border]="fieldInvalid('password') ? '1px solid #E11D48' : '1px solid #DDDFE6'"
                  [style.boxShadow]="passwordFocused() ? '0 0 0 4px rgba(91,75,227,0.13)' : 'none'"
            ...
            <div style="display:flex;align-items:center;gap:10px;">
              ...
              <span style="font-size:13.5px;color:#545A66;cursor:pointer;" (click)="toggleRemember()">Keep me logged in</span>
            </div>
            ...
            <button
              ...
              [style.opacity]="loginForm.invalid ? '0.6' : '1'"
              [style.cursor]="loginForm.invalid ? 'not-allowed' : 'pointer'"
              style="width:100%;font-family:inherit;border:none;background:#5B4BE3;color:#fff;font-weight:700;font-size:15.5px;padding:15px;border-radius:13px;box-shadow:0 8px 20px rgba(91,75,227,0.30);margin-top:2px;">
              Log in
            </button>
          ...
          <div style="display:flex;align-items:center;gap:12px;margin:20px 0;">
            ...
            <span style="font-size:12.5px;color:#B6BBC4;font-weight:500;">OR</span>
            <div style="flex:1;height:1px;background:#ECECEF;"></div>
          </div>
          ...
          <p style="text-align:center;font-size:14px;color:#545A66;margin:20px 0 0;">
            ...
            <a routerLink="/book" style="color:#5B4BE3;font-weight:700;text-decoration:none;">Sign up</a>
          </p>
...
export class LoginComponent {
  ...
  onSubmit(): void {
    if (this.loginForm.valid) {
      ...
      this.toastService.show('Please check your email and password.', 'error');
    }
  }
